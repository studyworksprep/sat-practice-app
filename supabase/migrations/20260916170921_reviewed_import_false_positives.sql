-- Allow an admin to dismiss reviewed prompt-text matches without bypassing source identity or new-match checks.
-- Keeps the RPC signature, authorization, retry behavior, locking, and grants unchanged.
