...
function ExcalidrawNodeView({ node, updateAttributes, deleteNode, editor }: NodeViewProps) {
  ...
  return (
    ...
    >
      {svg ? (
        // Inline SVG — generated by Excalidraw's exportToSvg, so the
        // contents are trusted in the same way our own server-side
        // HTML is. Wrapped in a fixed container so a giant scene
        // doesn't blow out the editor width.
        <div
