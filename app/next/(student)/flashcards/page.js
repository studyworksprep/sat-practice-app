...
// counts + average mastery, plus a "+ New set" form.
//
// URL: /flashcards (shared infra — the (student) layout exempts
// this prefix so tutors / managers can use their own libraries
// without bouncing through the role gate).
//
// Click a set's name → /flashcards/[setId] (full list with
// edit / delete). Click "Review" → /flashcards/[setId]/review
// (flip + self-rate flow). Per-card add still happens inline on
// the [setId] page, OR via the FlashcardsButton modal that's
// surfaced from question surfaces.
  ...
  return (
    <main className={s.container}>
      <header className={s.header}>
        <div className={s.eyebrow}>Flashcards</div>
