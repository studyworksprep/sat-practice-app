...
const HtmlBlock = memo(function HtmlBlock({ as = 'span', className, html }) {
  const Tag = as;
  // Defense-in-depth — admin-authored content goes through DOMPurify
  // before it hits dangerouslySetInnerHTML. The MathML/SVG profile
  // preserves all the math markup we need; <script>, on*, and
  // javascript: URIs are scrubbed.
