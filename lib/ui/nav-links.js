...
export const STUDENT_LINKS = [
  ...
  // Help is the new-student onboarding hub. Last in the row so it
  // doesn't displace the daily-driver tabs above, but always
  // present so a stuck student is one click away from a guide.
  { href: '/help',              label: 'Help', matchPrefix: '/help' },
];
