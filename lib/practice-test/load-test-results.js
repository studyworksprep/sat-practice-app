...
export async function loadTestResults({ supabase, attemptId, viewerUserId, viewerRole }) {
  ...
  // 8b3) Student-private notes for the per-question popover.
  //       Owner-only RLS scopes to the viewer; the tutor mirror
  //       loads the tutor's own notes here, which is harmless.
