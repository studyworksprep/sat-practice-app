...
// Score bands run 1–7 in the question bank; the visual tone reuses
// the 5-step diff palette so existing CSS keeps working: bands 1–2
// share the easy tile, 3–4 medium, 5 hard, 6 very-hard, 7 extreme.
const BAND_TONE = {
