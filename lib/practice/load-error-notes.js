...
export async function loadErrorNotes({ supabase, userId, limit = 200 }) {
  // /review/error-log is a SAT-only surface today; the loader joins to
  // questions_v2. PR 4 will branch the join target on test_type when the
  // ACT error log surfaces.
