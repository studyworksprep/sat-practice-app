...
function compileGraphWorkflow(specBlock, idx, existingIds) {
  ...
  if (specBlock.original_expression && !String(specBlock.original_expression).includes('=')) {
    issues.push(issue('warning', `blocks[${idx}].original_expression`, 'Expression may be missing y= for graphing.', 'Use y=... if graphing is intended.'));
  }
  if (specBlock.candidate_expression && !String(specBlock.candidate_expression).includes('=')) {
    issues.push(issue('warning', `blocks[${idx}].candidate_expression`, 'Expression may be missing y= for graphing.', 'Use y=... if graphing is intended.'));
  }
