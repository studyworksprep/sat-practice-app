...
test('deriveWizardStep walks the ladder one question at a time', () => {
  ...
  assert.equal(deriveWizardStep({ goal: null, testDate, intake: EMPTY_INTAKE, hasDraft: false }), 'target');
  assert.equal(deriveWizardStep({ goal, testDate: null, intake: EMPTY_INTAKE, hasDraft: false }), 'test_date');
