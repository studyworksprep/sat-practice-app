...
test('buildSyllabi groups by skill, orders by position, drops unpublished lessons', () => {
  const rows = [
    { id: 'b', position: 2, kind: 'drill', lesson_id: null, role: 'practice', skill_codes: null, technique_ids: null, question_count: 8, minutes: null, skip_if_completed: true, unit: { skill_code: 'H.A.', test_type: 'sat' }, lesson: null },
    { id: 'a', position: 1, kind: 'lesson', lesson_id: 'L1', role: null, skill_codes: null, technique_ids: null, question_count: null, minutes: null, skip_if_completed: true, unit: { skill_code: 'H.A.', test_type: 'sat' }, lesson: { title: 'Graphing', status: 'published' } },
    ...
    { id: 'd', position: 1, kind: 'drill', lesson_id: null, role: 'mixed', skill_codes: ['H.A.', 'H.B.'], technique_ids: null, question_count: null, minutes: 25, skip_if_completed: true, unit: [{ skill_code: 'H.B.', test_type: 'sat' }], lesson: null },
  ];
