              ...
              <td>
                ...
                <ol style="margin:0 0 12px 0;padding-left:20px;">
                  <li style="margin-bottom:8px;">
                    <strong>Take a baseline <a href="${url('/practice/tests')}" style="color:#102a43;">practice test</a>.</strong>
                  ...
                  <li style="margin-bottom:8px;">
                    <strong>Spend half an hour with your <a href="${url('/dashboard')}" style="color:#102a43;">Dashboard</a>.</strong>
                    The Performance grid shows your accuracy on every skill — red and yellow segments are
                    where the points are hiding.
                  </li>
                  <li style="margin-bottom:8px;">
                    <strong>Run a <a href="${url('/practice/start')}" style="color:#102a43;">Practice session</a> each weekday.</strong>
