...
<html>
            ...
            <tr>
              <td>
                ...
                <ol style="margin:0 0 12px 0;padding-left:20px;">
                  ...
                  <li style="margin-bottom:8px;">
                    <strong>Open <a href="${url('/today')}" style="color:#102a43;">Today</a> each study day.</strong>
                    One to three tasks, each with a reason it's there. Start with the top one.
                  </li>
                  <li style="margin-bottom:8px;">
  ...
  const text = [
    ...
    `2. Open Today each study day and start with the top task: ${url('/today')}`,
