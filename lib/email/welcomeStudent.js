  ...
  const cancelSection = isExempt
    ...
    : `
        ...
        <ol style="margin:0 0 12px 0;padding-left:20px;">
          <li style="margin-bottom:6px;">Sign in and open <a href="${url('/account/billing')}" style="color:#102a43;">Billing</a> from your account menu.</li>
        ...
        <p style="margin:0 0 12px 0;">
          ...
          live in the <a href="${url('/help/billing')}" style="color:#102a43;">Billing &amp; Subscription</a> help article.
        </p>
      `;
...
<html>
              ...
              <td>
                ...
                <ol style="margin:0 0 12px 0;padding-left:20px;">
                  <li style="margin-bottom:8px;">
                    <strong>Finish setting up your <a href="${url('/welcome')}" style="color:#102a43;">study plan</a>.</strong>
                    A few questions about where you are and when you can study, and Studyworks builds a
                    week-by-week plan and shows you the whole thing before you start.
                  </li>
                  <li style="margin-bottom:8px;">
                    <strong>Open your <a href="${url('/dashboard')}" style="color:#102a43;">Dashboard</a> each study day.</strong>
                    The Tasks box shows one to three tasks, each with a reason it's there. Start with the top one.
                  </li>
                  <li style="margin-bottom:8px;">
                    <strong>Trust the order early on.</strong>
                    Starting from scratch? The plan covers every topic first, then narrows to your weak
                    areas once it has seen a few weeks of your work.
                  </li>
                  <li style="margin-bottom:8px;">
                    ...
                    you need to actually learn. See the <a href="${url('/help/notes')}" style="color:#102a43;">Notes guide</a>.
                  </li>
                  <li style="margin-bottom:8px;">
                    <strong>Take the practice tests when the plan schedules them.</strong>
                    They're checkpoints: the plan adjusts itself weekly as your results come in.
                  </li>
                </ol>

                <h2 style="font-size:18px;margin:32px 0 8px 0;color:#0f172a;">What's in the sidebar</h2>
                <ul style="margin:0 0 12px 0;padding-left:20px;">
                  <li style="margin-bottom:6px;"><strong>Today</strong> — your plan's daily view: what to do next.</li>
                  <li style="margin-bottom:6px;"><strong>Dashboard</strong> — stats, performance breakdown, recent work.</li>
                ...
                <p style="margin:0 0 12px 0;">
                  The <a href="${url('/help')}" style="color:#102a43;">Help section</a> has full guides on
                  every part of the platform. Start with
                  <a href="${url('/help/getting-started')}" style="color:#102a43;">Welcome — Start Here</a>
                  or jump straight to the <a href="${url('/help/study-routine')}" style="color:#102a43;">Study Routine</a>
  ...
  const text = [
    ...
    '',
    'YOUR FIRST WEEK',
    `1. Finish setting up your study plan: ${url('/welcome')}`,
    `2. Open your Dashboard each study day and start with the top task: ${url('/dashboard')}`,
    '3. Trust the order early on — the plan covers every topic first, then narrows to your weak areas.',
    `4. Capture every miss with the right tool — Flashcards, Error Log, or Notes. See ${url('/help/notes')}`,
    '5. Take the practice tests when the plan schedules them — they are checkpoints.',
    '',
    "WHAT'S IN THE SIDEBAR",
    '- Today — your plan, day by day',
    '- Dashboard — stats, performance, recent work',
