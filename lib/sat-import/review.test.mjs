...
import { signReview, readReview, mergeOptions } from './review.ts';
...
test('review signature binds target, content, timestamp, actor and expiry', () => {
  ...
  for (const change of [{target:'other'}, {updatedAt:'new'}, {presentation:{...review.presentation,stem_html:'altered'}}]) {
