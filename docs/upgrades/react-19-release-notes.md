<!--
  React 19 release notes (Dec 2024)

  Source: https://raw.githubusercontent.com/reactjs/react.dev/main/src/content/blog/2024/12/05/react-19.md
  Fetched: 2026-04-13

  Upstream doc captured verbatim for Phase 1 dependency-upgrade planning.
  Do not edit the body. Re-run the curl command to refresh.
-->
