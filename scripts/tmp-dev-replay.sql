...
-- DEV PROJECT REPLAY — RESETS the public schema and re-runs
-- every migration file in alphabetical order. Safe only on
-- an empty dev project. Will wipe any existing data in the
-- public schema.
-- ============================================================

-- Wipe and recreate the public schema. Supabase's auth,
-- storage, and extensions schemas are separate and are NOT
-- affected. Do NOT run this block against production.
...
-- ============================================================
-- supabase/migrations/20230101000000_create_v1_question_schema.sql
-- ============================================================
-- =========================================================
