...
-- Generated concatenation of every file in supabase/migrations/
-- in alphabetical order, for the initial replay against the
-- fresh dev Supabase project. Paste into the dev project's SQL
-- Editor and click Run. Delete this file from the branch
